...
struct OutputWritePort: public out_port<Cache_write_t>{};
...
// Atomic Model instantiation 
	shared_ptr<dynamic::modeling::model> Hit_Write = dynamic::translate::make_dynamic_atomic_model<Hit_write,TIME>("Hit_Write");

	// TOP MODEL
	dynamic::modeling::Ports iports_TOP = {}; 
	dynamic::modeling::Ports oports_TOP = {typeid(OutputWritePort)};

dynamic::modeling::Models submodels_TOP = {input_reader_Parsed_Request, Hit_Write};
...
dynamic::translate::make_EOC<Hit_write_defs::Cache_write_out,OutputWritePort>("Hit_Write")
};

// IC links --> Internal Connections --> output to input 
dynamic::modeling::ICs ics_TOP = {

dynamic::translate::make_IC<iestream_input_defs<Parsed_Request_t>::out,Hit_write_defs::Request_in>("input_reader_Parsed_Request","Hit_Write")
};
...
// Don't change below until runner call
 ...
 /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/Hit_Write_out.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/Hit_Write_out.txt");
