...
int main(){
	...
	/******************MUX********************/
	int *select;
	printf("Select Cash Configuration:\n");
	printf("  - 0 : basic direct mapped cache\n");
	printf("  - 1 : prefetch linked mem\n");
	printf("  - 99 : Runtime reconfiguration (not available)\n");

	scanf("%d", select);

	//shared_ptr<dynamic::modeling::model> MUX = dynamic::translate::make_dynamic_atomic_model<Mux,TIME>("MUX");
	shared_ptr<dynamic::modeling::model> MUX = dynamic::translate::make_dynamic_atomic_model<Mux,TIME,int&>("MUX", *select);
	/*****************************************/
...
dynamic::translate::make_IC<Mux_defs::Config0_out,Config_0_defs::Parsed_request_in>("MUX","Config_0"),

dynamic::translate::make_IC<Mux_defs::Config1_out,Config_1_defs::Parsed_request_in>("MUX","Config_1"),

dynamic::translate::make_IC<Cache_defs::Hit_or_miss_out,Config_0_defs::hit_miss_in>("CACHE","Config_0"),

dynamic::translate::make_IC<Cache_defs::Hit_or_miss_out,Config_1_defs::hit_miss_in>("CACHE","Config_1"),

dynamic::translate::make_IC<Memory_request_manager_defs::Read_out,Config_0_defs::mem_read_in>("MEM","Config_0"),

dynamic::translate::make_IC<Memory_request_manager_defs::Read_out,Config_1_defs::mem_read_in>("MEM","Config_1"),

dynamic::translate::make_IC<Cache_defs::Block_out,Config_0_defs::cache_read_in>("CACHE","Config_0"),

dynamic::translate::make_IC<Cache_defs::Block_out,Config_1_defs::cache_read_in>("CACHE","Config_1"),

dynamic::translate::make_IC<Config_0_defs::Cache_write_out,Cache_defs::Write_request_in>("Config_0","CACHE"),

dynamic::translate::make_IC<Config_1_defs::Cache_write_out,Cache_defs::Write_request_in>("Config_1","CACHE"),

dynamic::translate::make_IC<Config_0_defs::Mem_write_out,Memory_request_manager_defs::Write_request_in>("Config_0","MEM"),

dynamic::translate::make_IC<Config_1_defs::Mem_write_out,Memory_request_manager_defs::Write_request_in>("Config_1","MEM"),

dynamic::translate::make_IC<Config_0_defs::Cache_read_request_out,Cache_defs::Read_request_in>("Config_0","CACHE"),

dynamic::translate::make_IC<Config_1_defs::Cache_read_request_out,Cache_defs::Read_request_in>("Config_1","CACHE"),

dynamic::translate::make_IC<Config_0_defs::Mem_read_request_out,Memory_request_manager_defs::Read_request_in>("Config_0","MEM"),

dynamic::translate::make_IC<Config_1_defs::Mem_read_request_out,Memory_request_manager_defs::Read_request_in>("Config_1","MEM"),

dynamic::translate::make_IC<Config_0_defs::tag_check_out,Cache_defs::Tag_check_in>("Config_0","CACHE"),

dynamic::translate::make_IC<Config_1_defs::tag_check_out,Cache_defs::Tag_check_in>("Config_1","CACHE"),

dynamic::translate::make_IC<Config_0_defs::Serviced_request_out,RequestManager_defs::Serviced_request_in>("Config_0","Request_Manager"),
