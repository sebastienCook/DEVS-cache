...
struct OutputPort: public out_port<string>{};

template<typename T>
class InputReader_read_request_t : public iestream_input<Cache_write_t,T> {
	public: 
		InputReader_read_request_t () = default; 
		InputReader_read_request_t (const char* file_path) : iestream_input<Cache_write_t,T>(file_path) {}
};
...
int main(){
	...
	shared_ptr<dynamic::modeling::model> Mem_manager = dynamic::translate::make_dynamic_atomic_model<Memory_request_manager,TIME>("Mem_manager");

	// TOP MODEL
	dynamic::modeling::Ports iports_TOP = {}; 
	dynamic::modeling::Ports oports_TOP = {typeid(OutputPort)};
	
	dynamic::modeling::Models submodels_TOP = {input_reader_write_request, input_reader_read_request, Mem_manager};
...
dynamic::translate::make_EOC<Memory_request_manager_defs::Read_out,OutputPort>("Mem_manager")
...
dynamic::translate::make_IC<iestream_input_defs<Cache_write_t>::out,Memory_request_manager_defs::Read_request_in>("input_reader_read_request","Mem_manager"),

dynamic::translate::make_IC<iestream_input_defs<Cache_write_t>::out,Memory_request_manager_defs::Write_request_in>("input_reader_write_request","Mem_manager")
};
...
// Don't change below until runner call
 ...
 /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/memory_request_manager_out.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/memory_request_manager_out.txt");
